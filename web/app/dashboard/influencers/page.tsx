      ...
      <div className='flex-1 space-y-4 p-8 pt-6'>
        <div className='flex items-center justify-between'>
          <div>
            ...
            <p className='text-muted-foreground'>Manage your AI influencer collection</p>
          </div>
        </div>
      ...
      {influencers.length === 0 ? (
        <Card className='py-12 text-center'>
          <CardHeader>
            ...
            <CardDescription>Create your first AI influencer to get started with content generation</CardDescription>
          </CardHeader>
          <CardContent>
            <Link href='/dashboard/create'>
              <Button>
          ...
          {influencers.map((influencer) => (
            <Card key={influencer.id} className='overflow-hidden transition-shadow hover:shadow-lg'>
              <div className='relative h-48 bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900 dark:to-pink-900'>
                <Image src={getPlaceholderImage(influencer)} alt={influencer.name} fill className='object-cover' />
