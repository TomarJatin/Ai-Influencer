            ...
            <CardContent>
              <div className="space-y-2">
                ...
                {influencer.styleAesthetic && (
                  <Badge variant="secondary">{influencer.styleAesthetic}</Badge>
                )}
                {influencer.eyeColor && (
                  <Badge variant="outline">Eyes: {influencer.eyeColor}</Badge>
                )}
                {influencer.hairColor && (
                  <Badge variant="outline">Hair: {influencer.hairColor}</Badge>
                )}
              </div>
            </CardContent>
          </Card>
            ...
            <TabsContent value="details" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Complete character specifications and settings
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  {(influencer.personalityArchetype || influencer.styleAesthetic) && (
                    <div>
                      <h4 className="font-medium mb-2">Character Identity</h4>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        {influencer.personalityArchetype && (
                          <div>
                  ...
                  {/* Physical Features */}
                  <div>
                    <h4 className="font-medium mb-2">Physical Features</h4>
                    <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  {influencer.keyFeatures && (
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{influencer.keyFeatures}</p>
                    </div>
                  )}
                  ...
                  {influencer.preferredLighting && (
                    <div>
                      <h4 className="font-medium mb-2">Technical Settings</h4>
