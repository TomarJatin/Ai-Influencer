...
export function GeneratedVideosSection({ influencer, onVideoGenerate }: GeneratedVideosSectionProps) {
  const stats = {
                ...
                <div className='flex items-center space-x-4'>
                  ...
                  <div className='min-w-0 flex-1 space-y-2'>
                    ...
                    <div className='flex items-center space-x-2'>
                      ...
                      {video.duration && <span className='text-muted-foreground text-xs'>{video.duration}s</span>}
                  ...
                  <div className='flex flex-shrink-0 items-center space-x-2'>
                    ...
                    <Button size='sm' variant='ghost' disabled={video.status !== 'COMPLETED'}>
          ...
          <CardContent className='flex flex-col items-center justify-center space-y-4 py-12'>
            ...
            <div className='space-y-2 text-center'>
              ...
              <p className='text-muted-foreground max-w-md text-sm'>
                Create engaging video content with your AI influencer. Videos can showcase their personality and create
                dynamic content.
              </p>
            </div>
            <Button onClick={onVideoGenerate}>
